...
do
	...
	then
		...
		--max_seq_length 430 --max_label_length 64 \
		--output_shortlist_path $dataset/trn_shortlist.json --encode_title
	else
		...
		--log_dir log_dir --eval_batch_size 640 --val_path $dataset/trn_shuf.json \
		--max_seq_length 430 --max_label_length 64 \
		--output_shortlist_path $dataset/trn_shortlist.json \
	...
	--model_path wizardlm13b --shortlist_path $dataset/trn_shortlist.json \
	--ouput_trn_llm_path $dataset/trn_pseudo.json --labels_path $dataset/lbl.json \
